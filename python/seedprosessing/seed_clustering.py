#This code is first kmeans clustering, then dimensionality reduction and then displayed
import cv2
import re
import numpy as np
import os
...
plt.title('PCA Projection of shape')
...
plt.savefig("10feature.png", dpi=600, bbox_inches='tight')
plt.show()